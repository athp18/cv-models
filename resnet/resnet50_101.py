...
class Bottleneck(nn.Module):
    expansion = 4  # Bottleneck expands the number of channels by 4x
    ...
    def __init__(self, in_channels, out_channels, stride=1, downsample=None):
        ...
        # 1x1 convolution to increase the number of channels back to the original dimension
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, out_channels, blocks, stride=1):
        downsample = None
        # Downsample if stride != 1 or in_channels doesn't match out_channels * block.expansion
...
if __name__ == "__main__":
    ...
    model = ResNet50()  # You can change this to ResNet101() to use ResNet-101
    model.to(device)
